...
[UsedImplicitly]
public class OnCardPlayedAddWombatPoopToHand : IStatusBuilder
{
    ...
    public DataFileBuilder<StatusEffectData, StatusEffectDataBuilder> Builder()
    {
        return Absent.StatusCopy("On Card Played Add Junk To Hand", Name)
            ...
            {
                status.effectToApply = Absent.GetStatus(InstantSummonWombatPoopInHand.Name);
                status.textInsert = Absent.CardTag(WombatPoop.Name);
            });
    }
}