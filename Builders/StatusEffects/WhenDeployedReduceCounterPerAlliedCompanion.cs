...
[UsedImplicitly]
public class WhenDeployedReduceCounterPerAlliedCompanion : IStatusBuilder
{
    ...
    public DataFileBuilder<StatusEffectData, StatusEffectDataBuilder> Builder()
    {
        return new StatusEffectDataBuilder(Absent.Instance)
            ...
            .WithText(
                $"When deployed, reduce own {Absent.VanillaKeywordTag("counter")} by <{{a}}> for each <Companion> on the board")
            .WithStackable(true)
