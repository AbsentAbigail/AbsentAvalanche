...
[UsedImplicitly]
public class OnCardPlayedIncreaseAlliesAttackEqualToFlight : IStatusBuilder
{
    ...
    public DataFileBuilder<StatusEffectData, StatusEffectDataBuilder> Builder()
    {
        return new StatusEffectDataBuilder(Absent.Instance)
            ...
            .WithText($"Increase all allies <keyword=attack> equal to their {Absent.KeywordTag("flight")}")
            .WithStackable(false)
