...
[UsedImplicitly]
public class OnCardPlayedAddHogCosplayToHand : IStatusBuilder
{
    ...
    public DataFileBuilder<StatusEffectData, StatusEffectDataBuilder> Builder()
    {
        return Absent.StatusCopy("On Card Played Add Junk To Hand", Name)
            ...
            {
                status.effectToApply = Absent.GetStatus(InstantSummonHogCosplayInHand.Name);
                status.textInsert = Absent.CardTag(HogCosplay.Name);
            });
    }
}