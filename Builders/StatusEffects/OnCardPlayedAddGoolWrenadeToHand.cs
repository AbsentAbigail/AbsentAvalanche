...
[UsedImplicitly]
public class OnCardPlayedAddGoolWrenadeToHand : IStatusBuilder
{
    ...
    public DataFileBuilder<StatusEffectData, StatusEffectDataBuilder> Builder()
    {
        return Absent.StatusCopy("On Card Played Add Junk To Hand", Name)
            ...
            {
                status.effectToApply = Absent.GetStatus(InstantSummonGoolWrenadeInHand.Name);
                status.textInsert = Absent.CardTag(GoolWrenade.Name);
            });
    }
}