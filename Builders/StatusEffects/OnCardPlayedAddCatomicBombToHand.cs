...
[UsedImplicitly]
public class OnCardPlayedAddCatomicBombToHand : IStatusBuilder
{
    ...
    public DataFileBuilder<StatusEffectData, StatusEffectDataBuilder> Builder()
    {
        return Absent.StatusCopy("On Card Played Add Junk To Hand", Name)
            ...
            {
                status.effectToApply = Absent.GetStatus(InstantSummonCatomicBombInHand.Name);
                status.textInsert = Absent.CardTag(CatomicBomb.Name);
            });
    }
}