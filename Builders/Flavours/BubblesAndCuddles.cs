...
[UsedImplicitly]
public class BubblesAndCuddles : IKeywordBuilder
{
    ...
    public DataFileBuilder<KeywordData, KeywordDataBuilder> Builder()
    {
        return new KeywordDataBuilder(Absent.Instance)
            ...
            .WithShowName(true)
            .WithDescription(
                "They/Them|" + Cards.Companions.BubblesAndCuddles.Flavour)
            .WithBodyColour(KeywordColours.Flavour)
            .WithNoteColour(KeywordColours.Gray)
            .AddToFlavours(Cards.Companions.BubblesAndCuddles.Name);
    }
}